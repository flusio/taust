...
docker-start: .env ## Start a development server
	...
	docker compose -p taust -f docker/development/docker-compose.yml up

.PHONY: docker-build
docker-build: ## Rebuild the Docker image
	docker compose -p taust -f docker/development/docker-compose.yml build

.PHONY: docker-clean
docker-clean: ## Clean the Docker stuff
	docker compose -p taust -f docker/development/docker-compose.yml down
